...
export const TRANSLATE = {
  ...
  ua: {
    ...
    bannerTitle: 'Наше завдання - <br> зробити ремонт простим і якісним',
    bannerText:
      'Асортимент РКЦ налічує всю необхідну продукцію як для котеджного і малоповерхового будівництва, так і для будівництва великих промислових обєктів. <br> Ми з радістю допоможемо у виборі найкращих матеріалів, саме для Вас. ',
    contacts: 'Контакти',
    ...
    copyrightTitle: '© Copyright - Всі права захищені 2020. LOREMIPSUMCOMPANY',
