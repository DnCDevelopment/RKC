...
export const TRANSLATE = {
  ru: {
    ...
    contactsHereToHelp: 'Мы здесь, чтобы помочь',
    ...
    productRecommended: 'Также вас могут заинтересовать',
    productBigPrice: 'Цену при большом объеме заказа уточняйте',
  ...
  ua: {
    ...
    contactFormText: 'Залиште свої контакти і ми звʼяжемося з Вами в найближчий час.',
    contactFormAgreement: 'Я згоден з умовами обробки персональних даних.',
    contactsHereToHelp: 'Ми тут, щоб допомогти',
    contactsHereToHelpText: `На сьогоднішній день мережа філій РКЦ налічує 9 представництв. Ми забезпечуємо логістику з наших складів по всій Україні. Якщо у Вас залишилися питання, ми з радістю відповімо на них! `,
    ...
    connectwithus: 'Звʼязатися з нами',
    ...
    orderStepsText: `Ми піклуємося про нашого клієнта. <br> Замовляючи у нас, Ви отримуєте максимальну якість продукту і послуг. Кожне замовлення для нас важливе, тому ми супроводжуємо клієнта на всіх етапах, що є гарантією якості і спокою.`,
    ...
    successOrder: "Дякуємо, оператор зв'яжеться з вами найближчим часом",
    formPlaceholderName: 'Введіть Ваше іʼмя',
...
export const CV_STEPS = {
  ...
  ua: [
    "Заповніть форму зворотнього зв'язку або скористайтеся кнопкою зворотнього дзвінка або телефонуйте нам за телефонами.",
...
export const HAPPY_TO_HELP = {
  ...
  ua: [
    ...
    `Ми забезпечуємо найвищу якість будівництва з кращими із доступних на ринку матеріалів.
    Наша команда орієнтована на довгострокову співпрацю і гарантує вигідні умови партнерства
    для кожного клієнта.`,
    `У будь-який момент ви можете звернутися до нас за консультацією, і наш фахівець підбере і
    прорахує необхідні обсяги матеріалів для вашого об'єкта.`,
