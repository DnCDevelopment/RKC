...
export const TRANSLATE = {
  ru: {
    ...
    bannerText:
      'Компания РКЦ-Строй берет на себя все хлопоты, связанные с ремонтом и строительством. Проконсультируем, подберем и доставим материалы, найдем лучших специалистов.\n Ассортимент РКЦ насчитывает всю необходимую продукцию как для коттеджного и малоэтажного строительства, так и для строительства крупных промышленных объектов.',
    contacts: 'Контакты',
  ...
  ua: {
    ...
    bannerText:
      "Компанія РКЦ-Строй бере на себе всі клопоти, пов'язані з ремонтом і будівництвом. Проконсультуємо, підберемо і доставимо матеріали, знайдемо кращих фахівців. Асортимент РКЦ налічує всю необхідну продукцію як для котеджного і малоповерхового будівництва, так і для будівництва великих промислових об'єктів.",
    contacts: 'Контакти',
